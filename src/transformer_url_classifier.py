...
from utils_and_classifiers import SimpleClassifiers, read_dataset, visualize_dataset_features, NeuralNetwork
...
def tokenize(data: DatasetDict) -> DatasetDict:
    ...
    """
    # Tokenize the texts
    tokenized_inputs = tokenizer(data['url'], padding="max_length", max_length=100, truncation=True, return_tensors="pt")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataset_path", type=str, default="../dataset/dataset_full_collection_with_url.json")
